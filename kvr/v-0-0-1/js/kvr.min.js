...
"Update date":"\u66f4\u65b0\u65e5\u671f","Kunniaa Design":"\u8363\u8000\u8bbe\u8ba1"};languageToggle.addEventListener("click",function(){isEnglish=!isEnglish;languageToggle.textContent=isEnglish?"\u4e2d\u6587":"EN";document.querySelectorAll("[data-translate]").forEach(a=>{const b=a.getAttribute("data-translate");a.textContent=isEnglish?b:translations[b]})});
...
helpSubMenu.addEventListener("click",()=>{helpSubMenu.classList.add("hidden")});const waveSurfer=WaveSurfer.create({container:document.getElementById("waveSurfer"),waveColor:"rgb(200, 0, 200)",progressColor:"rgb(100, 0, 100)",normalize:!0,media:audio});waveSurfer.on("ready",function(){document.getElementById("placeholderWaveform").style.display="none"});document.getElementById("fileInput").addEventListener("change",async a=>{if(a=a.target.files[0])await storeAudioFile(a.name,a),updatePlayList()});
