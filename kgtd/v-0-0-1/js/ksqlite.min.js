...
if(b)return b.value;console.log(`\u672a\u627e\u5230\u6570\u636e: ${a}`);return null}catch(b){return console.error("\u83b7\u53d6\u6570\u636e\u5931\u8d25:",b),null}};KSQLITE.checkKeyExists=async function(a){try{return void 0!==await KSQLITE.db[KSQLITE.objectStorName].get(a)}catch(b){return console.error("\u68c0\u67e5key\u662f\u5426\u5b58\u5728\u65f6\u51fa\u9519:",b),!1}};KSQLITE.createSqliteDB=async function(){KSQLITE.SQL=await initSqlJs({locateFile:b=>"js/sql-wasm.wasm"});if(KSQLITE.checkKeyExists("kgdt-things-sqlite")){var a=
await KSQLITE.getData("kgdt-things-sqlite");a=new KSQLITE.SQL.Database(new Uint8Array(a))}else a=new KSQLITE.SQL.Database;return a};KSQLITE.writeSqliteDBtoIndexedDB=async function(){const a=KGTD.sqliteDB.export().buffer;await KSQLITE.storeData("kgdt-things-sqlite",a)}})();
